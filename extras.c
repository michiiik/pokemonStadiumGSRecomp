...
/* Stadium 2's symbol table names this libultra entry osPiReadIo, while
 * librecomp exposes the equivalent implementation as osEPiReadIo. Keep the
 * generated overlay table linkable without changing generated files. */
extern void osEPiReadIo_recomp(uint8_t *rdram, recomp_context *ctx);
